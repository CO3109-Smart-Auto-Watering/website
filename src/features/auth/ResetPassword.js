...
const ResetPassword = () => {
  ...
  if (isValidating) {
    return (
      <Container>
        ...
        <Subtitle>Đang xác thực liên kết đặt lại mật khẩu...</Subtitle>
        <LoadingContainer>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (!isTokenValid) {
    return (
      <Container>
        ...
        <Header>Đặt lại mật khẩu</Header>
        <Message isError={true}>{message}</Message>
        <Button 
  ...
  return (
    <Container>
      ...
      <Header>Đặt lại mật khẩu</Header>
      <Subtitle>Vui lòng nhập mật khẩu mới cho tài khoản của bạn</Subtitle>
